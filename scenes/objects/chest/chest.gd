...
var corn_harvest_scene = preload("res://scenes/objects/harvest/corn.tscn")
var tomato_harvest_scene = preload("res://scenes/objects/harvest/tomato.tscn")
...
func _unhandled_input(event: InputEvent)->void:
	if in_range:
		if event.is_action_pressed("show_dialogue"):
			...
			#create some dialogue for the chest
